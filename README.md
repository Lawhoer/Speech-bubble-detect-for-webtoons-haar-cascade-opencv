...
```
C:/Users/erenn/Desktop/CODE/JAVA/lib/opencv/build/x64/vc16/bin/opencv_annotation.exe --annotations=pos.txt --images=positive/ --maxWindowHeight=800
``` 
...
```
C:/Users/erenn/Desktop/CODE/JAVA/lib/opencv_/opencv/build/x64/vc15/bin/opencv_createsamples.exe -info pos.txt -w 30 -h 30 -num 1000 -vec pos.vec
```
...
```
C:/Users/erenn/Desktop/CODE/JAVA/lib/opencv_/opencv/build/x64/vc15/bin/opencv_traincascade.exe -data casecade/ -vec pos.vec -bg neg.txt -w 30 -h 30 -numPos 101 -numNeg 202 -numStages 12 -maxFalseAlarmRate 0.3 -minHitRate 0.999
```
